...
public class JeonraExhibition extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_jeonra_exhibition, container, false);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = (RecyclerView) view.findViewById(R.id.firestore_list5);
        mFirestoreList.addItemDecoration(new DividerItemDecoration(getActivity(),DividerItemDecoration.VERTICAL));

        Query query = firebaseFirestore.collection("Exhibition").whereEqualTo("location","전라");
