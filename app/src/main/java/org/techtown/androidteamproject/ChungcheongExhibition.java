...
public class ChungcheongExhibition extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chungcheong_exhibition, container,false);

        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = (RecyclerView) view.findViewById(R.id.firestore_list3);
        mFirestoreList.addItemDecoration(new DividerItemDecoration(getActivity(),DividerItemDecoration.VERTICAL));

        Query query = firebaseFirestore.collection("Exhibition").whereEqualTo("location","충청");
